...
#ifndef AGG_PIXFMT_CMYK_INCLUDED
#define AGG_PIXFMT_CMYK_INCLUDED
...
namespace agg
{
    ...
    //======================================================blender_cmyk_pre
    template<class ColorT, class Order> struct blender_cmyk_pre
    {
        typedef ColorT color_type;
        typedef Order order_type;
        typedef typename color_type::value_type value_type;
    ...
    template<class Blender, class RenBuf> class pixfmt_alpha_blend_cmyk
    {
    public:
    ...
    //----pixfmt_cmyk32
    typedef pixfmt_alpha_blend_cmyk<blender_cmyk<cmyka8,  order_cmyk>, rendering_buffer>   pixfmt_cmyk32;
}
